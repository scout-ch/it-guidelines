...
export default function Clippy({ variant }: ClippyProps) {
  return (
    <svg className={variant} css={svgStyles} viewBox="0 0 91 248" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M31 104C31 104 31 128.5 31 156C31 183.5 66 184 66 156C66 128 66 84.5 66 40C66 -4.5 19 -9.5 19 40C19 89.5 19 151 19 199C19 247 78 248 78 199C78 150 78 104 78 104"
        stroke="#888"
        strokeWidth="8"
      />
